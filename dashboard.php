...
<body>
  ...
  <header class="navbar sticky-top bg-dark flex-md-nowrap p-0 shadow" data-bs-theme="dark">
    <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-white" href="#"><?= $_SESSION['usuario'] ?></a>
  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        ...
        <div class="mb-4">
          <a href="tareas/crear.php" class="btn btn-primary">Crear Nueva Tarea</a>
        </div>
        ...
        <div class="table-responsive small">
          ...
          <p>No tienes tareas aún. <a href="tareas/crear.php">Agrega una nueva tarea</a></p>
          <?php else: ?>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  ...
                  <a href="tareas/editar.php?id=<?= $tarea['id'] ?>" class="btn btn-warning btn-sm">Editar</a>
                  <a href="tareas/eliminar.php?id=<?= $tarea['id'] ?>" class="btn btn-danger btn-sm">Eliminar</a>
                </td>
              </tr>
              <?php endforeach; ?>
            </tbody>
